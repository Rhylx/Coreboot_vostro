package CB.Config is
   ...
   ANY_TOOLCHAIN                                  : constant boolean := true;
   ...
   SANDYBRIDGE_VBOOT_IN_ROMSTAGE                  : constant boolean := false;
   ...
   HWBASE_DEBUG_CB                                : constant boolean := false;
   ...
   PAYLOAD_FILE                                   : constant string  := "src/grub/default_payload.elf";
